             					...
             					<div  id="showmonthbtn" class="fbutton">
                						...
                						<span  class="">
                							Dairy User:<s:if test="%{#userList != 'null'}" >
				 											<s:select cssStyle="height: 20px;
																padding: 0px" id="diaryUser" name="diaryUser" list="userList" listKey="id" listValue="diaryUser" headerKey="0" theme="simple" headerValue="Select Practitioner"   />
														</s:if>
										</span>
									</div>
								</div>
								  <div class="btnseparator"></div>
            	 					<div  id="showmonthbtn" class="fbutton">
            	 						<div>
            	 							<span  class="">
            	 								<input id="gobtnid" type="submit" onclick="getDaySearch()" class="gosmall" value = "Go" style="margin-top: 0px; padding: 1px;"/>	
               								</span>
               							</div>
									</div>
									<div class="btnseparator"></div>
            				...
            				<td align="right">
            					<div id="showtodaybtn" class="fbutton">
								 ...
								 <div id="showdaybtn" class="fbutton">
                					<div>
                						<span title='Day' class="showdayview"><a href="dayNotAvailableSlot">Day</a></span>
                					</div>
            					</div>
           	 					 <div class="btnseparator"></div>
								 <div id="showdaybtn" class="fbutton">
