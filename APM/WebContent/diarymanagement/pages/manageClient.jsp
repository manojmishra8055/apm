...
<div id="login_main" class="main_layout_content">
	<h2 class="title" style="margin-right: 20px;margin-left: 45px">Client List</h2>
	...
	<div id="login" class="block_div">
		...
		<div class="diaryuser"> 
				...
				<div align="center"><s:textfield theme="simple" name="searchText" placeholder="Search by Name" size="80" cssClass="Search"/>
					...
					<a href="addManageClient" style="text-decoration: none" ><input type="button" class = "buttons" value = "Add New" style="margin-top: -19px; padding: 8px;">	</a>
				</div>
			</s:form>
			</div>
