	...
	<div class="loader"></div>
   	<div id="backgroundPopup"></div>
		<input type="hidden" name="diaryuserid" id="diaryuserid"/>
			...
			<div id="slotpopupdiv" style="background-color: #7ecefd;width: 697px;color: white;padding: 4px; width: 99%; height: 41px; display: none;">
			...
			<table id="slotpopuptable" width="100%" cellpadding="0" cellspacing="0" class="timer-table" style="display: none;">
				<col width="5%"/>
				<col width="10%"/>
				<col width="10%"/>
				<col width="10%"/>
		...
		<br>
		<table align="center" id="freeze-table" width="100%" style="font-size: 10px;" class="diarymngmnt-table" cellpadding="0" cellspacing="0">
			<tr>
			...
			<s:iterator value="tdUserList">
					...
					<tr id="<%=i %>">
						...
						<s:iterator value="monthtdList">
							<%if(j == 0){ %>
								<td style="background-color: rgba(126, 206, 253, 0.17)"><div style="height: 30px; font-weight: bold; "><s:property value="firstName"/> <s:property value="lastName"/></div></td>
							<% }%>
							<%j++; %>
