...
<script type="text/javascript" src="diarymanagement/js/addPatientTab.js"></script>
    ...
    <ul class="tab-menu">  
        <li id="nameAddress" class="active" onclick = "displayNameAddressTab()">Name/Address</li>  
        <li id="contacts" onclick="displayContactsTab()">Contacts</li> 
        <li id="otherInfo" onclick="displayOtherInfoTab()">Other Info</li>  
        <li id="sourceOfPayment" onclick="displaySourceOfPaymentTab()">Source of Payment</li>
				...
				<s:hidden id = "id" name = "id"></s:hidden>
					...
					<tr>
		 			<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Next" class="buttons" onclick="showContactsTab()"></td>
			    ...
			    <table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
				 ...
				 <col width="30%" />	
					...
					<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Previous" class="buttons" onclick="showPrevNameAddresTab()"></td>
		 						<td><input type="button" value="Next" class="buttons" onclick="showNextOtherInfoTab()"></td>
				...
				<col width="30%" />
					...
					<tr>
		 			<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Previous" class="buttons" onclick="showPrevOtherInfoTab()"></td>
		 						<td><input type="button" value="Next" class="buttons" onclick="showNextSourceOfPaymentTab()"></td>
		...
		<div id="sourceOfPayment-tab" class="tab-content">
			     <table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
                   ...
                   <s:if test="whopay == 'Third Party'">     
					...
					<table align="center">
		 					<tr>
		 						<td><input type="button" value="Previous" class="buttons" onclick="showPrevPaymentSourceTab()"></td>
