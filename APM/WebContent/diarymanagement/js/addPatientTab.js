...
function confirmedDelete(){
 ...
 function showContactsTab(){
	 	...
	 	var chk=0;
	   	if (firstname ==  "") {
	      	var firstName = document.createElement("label");
	        firstName.innerHTML = "First Name is required in Name/Address Tab";
	        document.getElementById('errorDiv').appendChild(firstName);
	        document.getElementById('errorDiv').appendChild(br);
	        chk=1;
	     }   
	     if (surname ==  "") {
	        var lastName = document.createElement("label");
	        lastName.innerHTML = "Last name is required in Name/Address Tab"; 
	        document.getElementById('errorDiv').appendChild(lastName);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	       	chk=1;
	     }
	     ...
	     if (dob ==  "") {
	        var dob = document.createElement("label");
	        dob.innerHTML = "Select DOB in Name/Address Tab"; 
	        document.getElementById('errorDiv').appendChild(dob);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	     ...
	     if (address ==  "") {
	        var address = document.createElement("label");
	        address.innerHTML = "Enter Address in Name/Address Tab"; 
	        document.getElementById('errorDiv').appendChild(address);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	      ...
	      if (country ==  "0") {
	        var country = document.createElement("label");
	        country.innerHTML = "Select country in Name/Address Tab"; 
	        document.getElementById('errorDiv').appendChild(country);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	        chk=1;
	     }
	     ...
	     {
	    	var contacts = document.getElementById("contacts-tab");
	 	 	contacts.className="tab-content active";
	 		var headcontacts = document.getElementById("contacts");
	 		headcontacts.className="active";
	 		var nameAddress = document.getElementById("nameAddress-tab");
	 		nameAddress.className="tab-content";
	 		var headnameAddress = document.getElementById("nameAddress");
	 		headnameAddress.className="none";
 ...
 function showPrevNameAddresTab(){
	 	var contacts = document.getElementById("contacts-tab");
	 	contacts.className="tab-content";
		var headcontacts = document.getElementById("contacts");
		headcontacts.className="none";
		var nameAddress = document.getElementById("nameAddress-tab");
		nameAddress.className="tab-content active";
		var headnameAddress = document.getElementById("nameAddress");
		headnameAddress.className="active";
 }
 
 function showNextOtherInfoTab(){
	     ...
	     if (mobile ==  "") {
	        var mobile = document.createElement("label");
	        mobile.innerHTML = "Mobile no is required in Contacts Tab"; 
	        document.getElementById('errorDiv').appendChild(mobile);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	  	 ...
	  	 var mobiledig = document.createElement("label");
	     mobiledig.innerHTML = "Enter valid mobile no in Contacts Tab"; 
	     document.getElementById('errorDiv').appendChild(mobiledig);
	     document.getElementById('errorDiv').appendChild(document.createElement('br'));
	  	chk=1;
		}
		...
		var dotpos=email.lastIndexOf(".");
		 if (email ==  "") {
	        var email = document.createElement("label");
	        email.innerHTML = "Enter email in Contacts Tab"; 
	        document.getElementById('errorDiv').appendChild(email);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	  	 ...
	  	 {	
	  	 	...
	  	 	var email1 = document.createElement("label");
	        email1.innerHTML = "Enter valid Email Contacts Tab"; 
	        document.getElementById('errorDiv').appendChild(email1);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	     ...
	     else
	     {
	    	var contacts = document.getElementById("contacts-tab");
	 		...
	 		var headcontacts = document.getElementById("contacts");
	 		headcontacts.className="none";
	 		var otherInfo = document.getElementById("otherInfo-tab");
	 		otherInfo.className="tab-content active";
	 		var headnameotherInfo = document.getElementById("otherInfo");
	 		headnameotherInfo.className="active";
 ...
 function showPrevOtherInfoTab(){
	 	var contacts = document.getElementById("contacts-tab");
	 	contacts.className="tab-content active";
		var headcontacts = document.getElementById("contacts");
		headcontacts.className="active";
		var otherInfo = document.getElementById("otherInfo-tab");
		otherInfo.className="tab-content";
		var headnameotherInfo = document.getElementById("otherInfo");
		headnameotherInfo.className="none";
 }

 function showNextSourceOfPaymentTab(){
	     ...
	     if (reference ==  "0") {
	        var reference = document.createElement("label");
	        reference.innerHTML = "Enter Refrence in Other Info Tab"; 
	        document.getElementById('errorDiv').appendChild(reference);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	     ...
	     if (occupation ==  "0") {
	        var occupation = document.createElement("label");
	        occupation.innerHTML = "Select Occupation in Other Info Tab"; 
	        document.getElementById('errorDiv').appendChild(occupation);
	        document.getElementById('errorDiv').appendChild(document.createElement('br'));
	     ...
	     {
	    	var sourceOfPayment = document.getElementById("sourceOfPayment-tab");
	    	sourceOfPayment.className="tab-content active";
	 		var headsourceOfPayment = document.getElementById("sourceOfPayment");
	 		headsourceOfPayment.className="active";
	 		var otherInfo = document.getElementById("otherInfo-tab");
	 		otherInfo.className="tab-content";
	 		var headnameotherInfo = document.getElementById("otherInfo");
	 		headnameotherInfo.className="none"; 
 ...
 function showPrevPaymentSourceTab(){
	 	var sourceOfPayment = document.getElementById("sourceOfPayment-tab");
 		sourceOfPayment.className="tab-content";
		var headsourceOfPayment = document.getElementById("sourceOfPayment");
		headsourceOfPayment.className="none";
		var otherInfo = document.getElementById("otherInfo-tab");
		otherInfo.className="tab-content active";
		var headnameotherInfo = document.getElementById("otherInfo");
		headnameotherInfo.className="active"; 
 ...
 function displayNameAddressTab(){
 ...
 function displaySourceOfPaymentTab(){
	 var reference = document.getElementById('reference').value;
