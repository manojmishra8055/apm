...
function goPreview(username,date,year,diaryuserid,tdcode){
	...
	document.getElementById('mon_id').innerHTML = "Monday"  + " " + caldate + " " + str[0];
		caldate = caldate+1;
		month = getMonthName(caldate,str[0],year)
		caldate = getCalDate(caldate,str[0],year);
		
	document.getElementById('tue_id').innerHTML = "Tuesday"  + " " + caldate + " " + month;
		caldate = caldate+1;
		month = getMonthName(caldate,month,year)
		caldate = getCalDate(caldate,str[0],year);
		
	document.getElementById('wed_id').innerHTML = "Wednesday" + " " + caldate + " " + month;;
		caldate = caldate+1;
		month = getMonthName(caldate,month,year)
		caldate = getCalDate(caldate,str[0],year);
		
	document.getElementById('thu_id').innerHTML = "Thursday" + " " + caldate + " " + month;;
		caldate = caldate+1;
		month = getMonthName(caldate,month,year)
		caldate = getCalDate(caldate,str[0],year);
		
	document.getElementById('fri_id').innerHTML = "Friday" + " " + caldate + " " + month;;
		caldate = caldate+1;
		month = getMonthName(caldate,month,year)
		caldate = getCalDate(caldate,str[0],year);
		
	document.getElementById('sat_id').innerHTML = "Saturday" + " " + caldate + " " + month;;
		caldate = caldate+1;
		month = getMonthName(caldate,month,year)
		caldate = getCalDate(caldate,str[0],year);
		
	document.getElementById('sun_id').innerHTML = "Sunday" + " " + caldate + " " + month;;
