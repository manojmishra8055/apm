...
(function( $ ) {
  ...
  */
  $.fn.freezeTableColumnsLayout = function(options) {
    ...
    $('#' + main_id + '-region1').children('div').width(4000);
    $('#' + main_id + '-region2').children('div').width(4000);
    $('#' + main_id + '-region3').children('div').width(4000);
    $('#' + main_id + '-region4').children('div').width(4000);
