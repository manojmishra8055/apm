...
<div class="main_layout_content">
    ...
    <ul class="tab-menu">  
        <li id="generalInformation" class="active" onclick = "displayGeneralInfoTab()">General Information</li>  
        <li id="packageSubscription" onclick = "displayPackageSubTab()">Package Subscription</li>  
        <li id="functionalitySubscription" onclick="displayFunctSubTab()">Functionality Subscription</li>
        <li id="accountInformation" onclick = "displayAccInfoTab()">Account Information</li>  
        <li id="clinicLocation" onclick="displayClinicLocTab()">Clinic Location</li>  
			    ...
			    <table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
		 		...
		 		<tr>
		 			<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Next" onclick="return showPackageSubTab()" class="buttons"></td>
			    ...
			    <table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
		 		...
		 		<tr>
		 			<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Previous" onclick="showGeneralInfoTab()" class="buttons"></td>
		 						<td><input type="button" value="Next" onclick="showFuctSubTab()" class="buttons"></td>
			    ...
			    <table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
		 		...
		 		<tr>
		 			<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Previous" onclick="showPrevFuctSubTab()" class="buttons"></td>
		 						<td><input type="button" value="Next" onclick="showAccountInfoTab()" class="buttons"></td>
			    ...
			    <table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
		 		...
		 		<tr>
		 			<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Previous" onclick="showPrevAccInfoTab()" class="buttons"></td>
		 						<td><input type="button" value="Next" onclick="showClinicLocTab()" class="buttons"></td>
		...
		<div id="clinicLocation-tab" class="tab-content">
			...
			<!-- Lcation1 --> 	
				...
				<tr>
		 		...
		 		<tr>
					<td><INPUT type="button" value="Add More" onclick="addRow('addressesTable')" class="buttons"/> 
					<INPUT type="button" value="Delete Row" onclick="deleteRow('addressesTable')" class="buttons" /> </td>
				</tr>
		 		...
		 		<tr>
		 			<td colspan="3">
		 				<table align="center">
		 					<tr>
		 						<td><input type="button" value="Previous" onclick="showPrevClinicInfoTab()" class="buttons"></td>
		 						<td><s:submit theme="simple" cssClass="buttons" value="Save"/></td>
