...
<div id="login_main" class="main_layout_content">
	<h2 class="title">Practitioner List</h2>
		...
		<div class="diaryuser"> 
			<s:form action="UserProfile" theme="simple">
				<div align="center"><s:textfield theme="simple" name="searchText" placeholder="Search by Name" size="80" cssClass="Search"/>
					...
					<a style="text-decoration: none" href="inputUserProfile" ><input type="button"  value="Add New" class="buttons" style="margin-left: 8px; padding: 8px;"/></a>
				</div>
			</s:form>
		</div>
