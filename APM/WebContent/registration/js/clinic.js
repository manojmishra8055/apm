...
function showPackageSubTab(){
	...
	if (clinicName ==  "") {
     ...
     {	
    	 	var packageSub = document.getElementById("packageSubscription-tab");
    		packageSub.className="tab-content active";
    		var headPack = document.getElementById("packageSubscription");
    		headPack.className="active";
    		var generalInfo = document.getElementById("generalInformation-tab");
    		generalInfo.className="tab-content";
    		var genralPack = document.getElementById("generalInformation");
    		genralPack.className="none";
    		return true;
     }
...
function showGeneralInfoTab(){
	var packageSub = document.getElementById("packageSubscription-tab");
	packageSub.className="tab-content";
	var headPack = document.getElementById("packageSubscription");
	headPack.className="none";
	var generalInfo = document.getElementById("generalInformation-tab");
	generalInfo.className="tab-content active";
	var genralPack = document.getElementById("generalInformation");
	genralPack.className="active";
	
	
}

function showFuctSubTab(){
	document.getElementById('errorDiv').innerHTML="";
	var chk=0;
	 var pkgsubscription = document.getElementsByName("pkgsubscription");
	    ...
	    if(okay){
	    	var functSub = document.getElementById("functionalitySubscription-tab");
	    	functSub.className="tab-content active";
	    	var headFunct = document.getElementById("functionalitySubscription");
	    	headFunct.className="active";
	    	var packageSub = document.getElementById("packageSubscription-tab");
	    	packageSub.className="tab-content";
	    	var headPack = document.getElementById("packageSubscription");
	    	headPack.className="none";
...
function showAccountInfoTab(){
    ...
    if(okay1){
    	var accInfo = document.getElementById("accountInformation-tab");
    	accInfo.className="tab-content active";
    	var headAccInfo = document.getElementById("accountInformation");
    	headAccInfo.className="active";
    	
    	var functSub = document.getElementById("functionalitySubscription-tab");
    	functSub.className="tab-content";
    	var headFunct = document.getElementById("functionalitySubscription");
    	headFunct.className="none";
...
function showPrevAccInfoTab(){
	var accInfo = document.getElementById("accountInformation-tab");
	accInfo.className="tab-content";
	var headAccInfo = document.getElementById("accountInformation");
	headAccInfo.className="none";
	    ...
	    if(confirmPassword == ""){
	     ...
	     else
	     {
	    	 var accInfo = document.getElementById("accountInformation-tab");
	    		...
	    		var clincLocSub = document.getElementById("clinicLocation-tab");
	    		clincLocSub.className="tab-content active";
	    		var headClinic = document.getElementById("clinicLocation");
	    		headClinic.className="active";
...
function showPrevClinicInfoTab(){
	var accInfo = document.getElementById("accountInformation-tab");
	accInfo.className="tab-content active";
	var headAccInfo = document.getElementById("accountInformation");
	headAccInfo.className="active";
	...
	var clincLocSub = document.getElementById("clinicLocation-tab");
	clincLocSub.className="tab-content";
	var headClinic = document.getElementById("clinicLocation");
	headClinic.className="none";
