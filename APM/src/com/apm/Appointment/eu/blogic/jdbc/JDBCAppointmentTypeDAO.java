...
public class JDBCAppointmentTypeDAO extends JDBCBaseDAO implements AppointmentTypeDAO{
	...
	public ArrayList<AppointmentType> getAppointmentTypeList(Pagination pagination) {
		...
		String sql = "SELECT id,name,description,category,duration,colorcode,charges,location FROM apm_appointment_type";
		...
		try{
			...
			while(rs.next()){
				...
				appointmentType.setLocation(rs.getString(8));
	...
	public int saveAppointmentType(AppointmentType appointmentType) {
		PreparedStatement preparedStatement = null;
		int result = 0;
		String sql = "insert into apm_appointment_type(name,description,category,duration,colorcode,charges,location) values(?,?,?,?,?,?)";
		...
		try{
			...
			preparedStatement.setString(7, appointmentType.getLocation());
	...
	public AppointmentType getAppointment(int id) {
		PreparedStatement preparedStatement = null;
		AppointmentType appointmentType = new AppointmentType();
		String sql = "SELECT id,name,description,category,duration,colorcode,charges,location FROM apm_appointment_type where id = "+id+" ";
	...
	public int updateAppointmentType(AppointmentType appointmentType,int id) {
		PreparedStatement preparedStatement = null;
		int result = 0;
		String sql = "update apm_appointment_type set name = ?,description = ?,category = ?,duration = ?,colorcode = ?,charges = ?,location = ? where id = "+id+"";
