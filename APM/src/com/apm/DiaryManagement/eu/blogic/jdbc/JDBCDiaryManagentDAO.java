...
public class JDBCDiaryManagentDAO extends JDBCBaseDAO implements DiaryManagementDAO {
	...
	public ArrayList<DiaryManagement> getPractionerList(int year,int clinicid,Pagination pagination,String searchText) {
		PreparedStatement preparedStatement = null;
		ArrayList<DiaryManagement>list = new ArrayList<DiaryManagement>();
		String sql = "select id,firstname,lastname,diarycolor from apm_user where usertype = 4 and clinicid = "+clinicid+" and  firstname like('%"+searchText+"%') " ;
	...
	public int getDiarymanagementTotalUser(int year, int clinicid,
		...
		PreparedStatement preparedStatement = null;
		int result = 0;
		String sql = "select count(*) from apm_user where usertype = 4 and clinicid = 8  and firstname like('%"+searchText+"%')";
