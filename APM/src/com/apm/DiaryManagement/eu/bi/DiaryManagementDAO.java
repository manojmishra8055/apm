...
public interface DiaryManagementDAO {
	...
	ArrayList<DiaryManagement> getPractionerList(int year,int clinicid,Pagination pagination,String searchText);
	...
	int getDiarymanagementTotalUser(int year,int clinicid, String searchText);
